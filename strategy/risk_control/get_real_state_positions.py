...
class RealStatePositions:
    ...
    def get_positions(self):
        ...
        for ticker_usd in tickers_usdt_m:
            tickers_pos_usdt_m[ticker_usd] = self.data_provider_usdt_m.get_amount_positions(ticker_usd)
        for ticker_coin in tickers_coin_m:
            tickers_pos_coin_m[ticker_coin] = self.data_provider_coin_m.get_amount_positions(ticker_coin)
        return {'USDT-M': tickers_pos_usdt_m, 'COIN-M': tickers_pos_coin_m}
